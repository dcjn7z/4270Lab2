...
[0x04000028]    beq   $a6, $a3, +0xC// if i == 0 if not jumps to 0x04000034
[0x0400002C]    addiu $a1, $a1, 0x1 // prev++           
[0x04000030]    addiu $a0, $a0, 0x1 // current++
[0x04000034]    beq   $a6, $a3, +0x14 // jump to increment i 0x04000048
...
[0x0400004C]    beq $a6, $a5, -0x28//if branch is taken jumps back to 0x04000028
